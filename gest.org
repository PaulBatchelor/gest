...
struct gest_target {
    ...
    SKFLT (*mix)(gest_d *, SKFLT, SKFLT, SKFLT, void *);
    void *ud;
    gest_target *next;
    <<temporal_weight>>
};
...
#+NAME: static_funcdefs
#+BEGIN_SRC c
static SKFLT default_mix(gest_d *g,
                         SKFLT x, SKFLT y, SKFLT a,
                         void *ud);
#+END_SRC
...
#+BEGIN_SRC c
if (g->curtarget != NULL) {
    out = g->curtarget->tick(g, out, g->curtarget->ud);
    out = g->curtarget->mix(g,
                            g->curval, g->nxtval, out,
                            g->curtarget->ud);
}
#+END_SRC
